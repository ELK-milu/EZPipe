...
class SampleModule(BaseModule):
    ...
    def process(self, user: str, input_data: Any) -> bytes:
        # 模拟音频接收逻辑
...
class ASRModule(BaseModule):
    ...
    def process(self, user: str, input_data: bytes) -> str:
        # 模拟ASR处理
...
class LLMModule(BaseModule):
    ...
    def process(self, user: str, input_data: str) -> str:
        # 模拟LLM处理
...
class TTSModule(BaseModule):
    ...
    def process(self, user: str, input_data: str) -> bytes:
        # 模拟TTS处理
